...
export const eMode = {
    ...
    PDF_VIEWER_THERAPY_MANUAL: "mode-pdf-viewer-therapy-manual",
    PDF_VIEWER_SPEECH_ASSESSMENT: "mode-pdf-viewer-speech-assessment",
    PDF_VIEWER_THERAPY_WORKSHEETS: "mode-pdf-viewer-therapy-worksheets",
